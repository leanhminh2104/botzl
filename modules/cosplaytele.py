...
des = {
    'version': "1.0.1",
    'credits': "LAMDev",
    'description': "Gửi ảnh cosplaytele"
}
...
def handle_anhgai_command(message, message_object, thread_id, thread_type, author_id, client):
    try:
        api_list = [
            "http://api.lamdev.x10.bz/images/cosplaytele/"
        ]
        ...
        client.sendImage(
            ...
            width=1200,
            height=1600,
            message=Message(text="🖼️ Ảnh cosplaytele cho bạn nè! 💖"),
            ttl=300000  # Thêm TTL
        )
...
def get_tmii():
    return {
        'cosplaytele': handle_anhgai_command
    }
