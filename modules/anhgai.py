...
def handle_anhgai_command(message, message_object, thread_id, thread_type, author_id, client):
    try:
        api_list = [
            "https://api.sumiproject.net/images/girl",
            "https://api-dowig.onrender.com/images/girl",
            "https://api-dowig.onrender.com/images/ausand",
            "https://api-dowig.onrender.com/images/gentle",
            "https://api-dowig.onrender.com/images/naughty"
        ]
        ...
        client.sendImage(
            ...
            width=1200,
            height=1600,
            message=Message(text="🖼️ Ảnh gai cho bạn nè! 💖"),
            ttl=100000  # Thêm TTL
        )
