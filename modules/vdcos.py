...
# Danh sách nhiều API
VIDEO_API_LIST = [
    "https://api-dowig.onrender.com/images/videochill",
    "https://api.leanhminh.io.vn/video/videocosplay/"
]
...
def handle_chill_command(message, message_object, thread_id, thread_type, author_id, client):
    ...
    try:
        ...
        client.sendRemoteVideo(
            ...
            width=width,
            height=height,
            message=Message(text="🎬 Video Cosplay cho bạn nè! 💖"),
            ttl=300000
        )
