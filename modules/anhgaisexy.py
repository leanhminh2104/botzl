...
def handle_anhgai_command(message, message_object, thread_id, thread_type, author_id, client):
    try:
        api_list = [
            "https://api-dowig.onrender.com/images/girlsexy",
            "https://api-dowig.onrender.com//images/tw",
            "https://api-dowig.onrender.com/images/ig",
            "https://api-dowig.onrender.com/images/help"
        ]
        ...
        client.sendImage(
            ...
            width=1200,
            height=1600,
            message=Message(text="🖼️ Ảnh gaisexy cho bạn nè! 💖"),
            ttl=300000  # Thêm TTL
        )
...
def get_tmii():
    return {
        'anhgaisexy': handle_anhgai_command
    }
